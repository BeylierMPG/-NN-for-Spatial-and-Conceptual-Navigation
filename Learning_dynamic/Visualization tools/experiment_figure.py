...
class Experiment:
    ...
    def Target_position(self):
        self.Target_position_grid = np.eye(self.width+4)
        self.Target_position_grid[0,1]=1
        self.Target_position_grid[self.width+4-1,self.width+4-2]=1
    ...
    def data_generator_evaluation(self,type_of_seed):
    ...
    def Create_Dataset(self,NUMBER_OF_BLOCKS,NUMBER_OF_TRIALS,FUSION):
        target = []
        ...
        for k in range(NUMBER_OF_BLOCKS):
            for i in range(NUMBER_OF_TRIALS):
                ...
                data_evaluation.append(self.data_generator_evaluation(type_of_seed = np.mod(k,2)))
        ...
        for a in data_evaluation :
            if FUSION:
                ...
                if (a[2] == a[3] or a[2] == a[3]+1 or a[2] == a[3]-1):
                    target_evaluation.append(1.0)
                else:
                    target_evaluation.append(0.0)                          
